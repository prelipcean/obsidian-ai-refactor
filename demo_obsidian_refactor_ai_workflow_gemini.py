...
# Initialize the OpenAI client for Gemini with the correct base URL
client = OpenAI(
...
def validate_environment():
    ...
    Checks for required dependencies and the GEMINI API key.
    """
    ...
    # Check for OpenAI library (used for Gemini-compatible API)
    try:
        import openai
